    ...
    <>
      ...
      <div className="container">
        ...
        <table align="center" className="mt-4 table table-responsive">
          <thead>
            <tr align="center">
              <th colSpan={3}><h4><strong>Chromium Connect</strong></h4></th>
            </tr>
          </thead>
          <tbody>
            <tr>
              <td rowSpan={3}><strong>Fee-for-service</strong></td>
              <td>PARI Member<sup>1</sup></td>
              <td style={{width: "40%"}}>$300 for the first sample and $50 per additional sample</td>
            </tr>
            <tr>
              <td>University of Manitoba</td>
              <td>$315 for the first sample and $65 per additional sample</td>
            </tr>
            <tr>
              <td>Industry</td>
              <td>$450 for the first sample and $150 per additional sample</td>
            </tr>
            <tr>
              <td><strong>Late Fee<sup>2</sup></strong></td>
              <td>$55/hour</td>
